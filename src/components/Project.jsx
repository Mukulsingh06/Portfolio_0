...
const Project = ({ onHover, onLeave }) => {
  return (
    <div className='bg-[rgba(255,255,255,0.15)] w-225 h-130 ml-auto mt-20 m-10 opacity-100 backdrop-blur-sm rounded-4xl p-5' onMouseEnter={onHover} onMouseLeave={onLeave}>
